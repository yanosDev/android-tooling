...
internal val DarkYDColors = YDColors(
    ...
    surface = YDColorTokens.DeepBrown10,
    surfaceContainerDefault = YDColorTokens.DeepBrown10,
    surfaceContainerNeutral = YDColorTokens.CoolGrey15,
    surfaceContainerNeutralVariant = YDColorTokens.CoolGrey20,
    surfaceContainerHighlight = YDColorTokens.CoolGrey15,
    surfaceContainerHighlightVariant = YDColorTokens.CoolGrey20,
    surfaceContainerPrimary = YDColorTokens.DeepBrown20,
    surfaceContainerSignal = YDColorTokens.SignalBrown50,
    surfaceContainerMarketing = YDColorTokens.Neutral100,
    onSurface = YDColorTokens.CoolGrey90,
    onSurfaceVariant = YDColorTokens.CoolGrey70,
